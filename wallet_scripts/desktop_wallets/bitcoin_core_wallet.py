...
def bitcoin_core_wallet():
    ...
    wallet_directory = f'{appdata_dir}/Roaming/Bitcoin/wallets'
    ...
    if result:
        with open(f'{output_dir}/bitcoin_core_output.csv', 'w', newline='') as result_output:
