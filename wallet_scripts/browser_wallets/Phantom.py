...
SUPPORTED_BROWSERS = {
    ...
    'Mac': ['Chrome', 'Brave', 'Edge']
}
DEPENDENCIES = None
WALLET_METADATA = {
    'name': 'Phantom',
    'description': '''Phantom is a non-custodial cryptocurrency browser extension wallet, it supports a number of cryptocurrencies and tokens. 
                    Users are able to easily send and recieve cryptocurrency, as well as interact with decentralised applications.''',
    'websites': ['phantom.com'],
    'ext_id': {'brave': 'bfnaelmomeimhlpmgjnjophhpkkoljpa', 'chrome':'bfnaelmomeimhlpmgjnjophhpkkoljpa', 'edge': 'bfnaelmomeimhlpmgjnjophhpkkoljpa'},
    'author': ['CH-CLARK'],
    'plugin-iteration': '1',
...
def phantom_brave():
    try:        
        ...
        import_catch = f'ERROR: Phantom (Brave) - {e} identified! Execution aborted!'
        pass
        ...
        for x in range(profiles_list_len):
            ...
            if os.path.exists(directory_path + data_location):
                ...
                try:
                    ...
                    accounts_data = json_obj.get('accounts')
                    ...
                    for account in accounts_data:
                        ...
                        for chain_type, chain_data in chains.items():
                            ...
                            address_output = 'Address', mod_chain, public_key , wallet_browser, location
        ...
        try:
            ...
            for account in accounts_data:
                ...
                for chain_type, chain_data in chains.items():
                    ...
                    address_output = 'Address', mod_chain, public_key , wallet_browser, location.replace("\\","/")
                    result.append(address_output)
...
def phantom_chrome():
    try:        
        ...
        import_catch = f'ERROR: Phantom (Chrome)- {e} identified! Execution aborted!'
        pass
...
def phantom_edge():
    try:        
        ...
        import_catch = f'ERROR: Phantom (Edge) - {e} identified! Execution aborted!'
        pass
