...
def metamask_brave():
    try:        
        ...
        import_catch = f'ERROR: MetaMask (Brave) - {e} identified! Execution aborted!'
        pass
...
def metamask_edge():
    try:        
        ...
        import_catch = f'ERROR: MetaMask (Edge) - {e} identified! Execution aborted!'
        pass
