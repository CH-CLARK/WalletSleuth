...
class Output_Frame(ttk.Frame):
    def __init__(self, container) -> None:
        ...
        self.tree = ttk.Treeview(self.table_margin, columns=("Type", "Currency", "Address", "Wallet", "Path"), height=145, selectmode="extended", yscrollcommand=self.scrollbar_y.set, xscrollcommand=self.scrollbar_x.set)
