...
class Output_Frame(ttk.Frame):
    ...
    def __init__(self, container) -> None:
        ...
        self.tree = ttk.Treeview(self.table_margin, columns=("Currency", "Address", "Wallet", "Path"), height=400, selectmode="extended", yscrollcommand=self.scrollbar_y.set, xscrollcommand=self.scrollbar_x.set)
        ...
        self.tree.column('#4', stretch=NO, minwidth=0, width=800)
        self.tree.pack()
